...
function debug_log($message) {
    ...
    file_put_contents($debug_file, "[$timestamp] $message" . PHP_EOL, FILE_APPEND);
}

debug_log("=== New message attempt ===");
...
debug_log("Message type: $messageType (1=user, 2=admin)");
...
try {
    ...
    try {
        ...
        if ($isAjax) {
            ...
            debug_log("Redirect to meus_tickets.php?error=2");
        }
    }
} catch (Exception $e) {
