...
<nav class="sidebar-helpdesk bg-white shadow-sm d-flex flex-column" id="sidebar" aria-label="Menu principal">   
    ...
    <div class="mt-2">
        <ul class="nav flex-column m-0 p-0">
            ...
            <?php if (isset($_SESSION['admin_id'])): ?>
                ...
                <li class="nav-item px-2 py-1">
                    <a href="tickets_atribuidos.php" id="tickets" class="menu-link nav-link rounded-2 px-3 py-2 d-flex align-items-center text-dark <?php echo basename($_SERVER['PHP_SELF']) == 'tickets_atribuidos.php' ? 'active' : ''; ?>">
                ...
                <li class="nav-item px-2 py-1">
                    <a href="consultar_tickets.php" id="tickets-all" class="menu-link nav-link rounded-2 px-3 py-2 d-flex align-items-center text-dark <?php echo basename($_SERVER['PHP_SELF']) == 'consultar_tickets.php' ? 'active' : ''; ?>">
                        <i class="bi bi-list-check me-3 nav-menu-item" aria-hidden="true"></i> 
    ...
    <div class="mt-auto p-3 border-top">
        <div class="d-flex align-items-center user-profile-link rounded p-2">
            <div class="user-avatar rounded-circle bg-primary text-white d-flex align-items-center justify-content-center me-2">
                <?php echo strtoupper(substr($_SESSION['admin_name'], 0, 1)); ?>
            </div>
            <div class="d-flex flex-column">
                <span class="fw-medium text-dark"><?php echo $_SESSION['admin_name']; ?></span>
                <small class="text-muted"><?php echo $_SESSION['admin_email'] ?? ''; ?></small>
            </div>
        </div>
        <a href="logout.php" class="btn btn-danger btn-sm w-100 mt-3 d-flex align-items-center justify-content-center btn-logout">
...
<div class="sidebar-overlay position-fixed top-0 start-0 w-100 h-100 bg-dark bg-opacity-50 d-lg-none" style="z-index: 1025; display: none;"></div>
