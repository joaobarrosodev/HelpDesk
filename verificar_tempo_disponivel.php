...
function verificarTempoDisponivel($entity, $tempoNecessario, $pdo, $permitirDebito = false) {
    try {
        ...
        // CORREÇÃO: Usar a mesma estrutura de query que funciona no sistema
...
function distribuirTempoContratos($entity, $tempoGasto, $ticketId, $pdo) {
    try {
        ...
        // CORREÇÃO: Usar a mesma estrutura de query
...
function criarDebitoTempo($entity, $tempoDevido, $ticketId, $pdo) {
    try {
        ...
        // CORREÇÃO: Usar KeyId para identificar a entidade
